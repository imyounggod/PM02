...
3. Начальное меню
4. Начальный поиск
5. Инициализация дополнительные параметры
6. Слайдер списка инициализации
7. Инициализация лайтбокс
8. Добавление Google Map
9. Форма поиска инициативы
...
$(document).ready(function()
{
	...
	*/
	...
	function initGoogleMap()
	{
    	...
    	// Инициализируем карту с опциями
    	map = new google.maps.Map(document.getElementById('map'), mapOptions);
   
		// Перецентрировать карту после изменения размера окна
